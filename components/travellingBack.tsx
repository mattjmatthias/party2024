...
const TravellingBack: NextPage = () => {
  return (
    <section className="w-[1344px] flex flex-row items-start justify-start p-[80px] pb-[0px] mq825:p-[50px] box-border max-w-full text-left text-13xl text-black font-small-text mq825:box-border mq1425:box-border">
