...
const AfterParty: NextPage = () => {
  return (
    <section className="w-[1347px] flex flex-row items-start justify-start p-[80px] pb-[40px] mq825:p-[50px] box-border max-w-full text-left text-5xl text-black font-futura lg:box-border mq825:box-border mq1425:box-border">
      <div className="flex-1 flex flex-col items-start justify-start gap-[44px] max-w-full mq825:gap-[22px]">
        ...
        <div className="w-[702px] flex flex-col items-start justify-start pt-0 px-0 pb-[53px] box-border gap-[30px] max-w-full mq450:pb-[34px] mq450:box-border">
