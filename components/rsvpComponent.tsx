...
import sentLottie from "../public/sent.json";
...
const RsvpComponent: NextPage<RsvpProps> = ({ displayMoreInfo, id }) => {
  ...
  const headerClasses = displayMoreInfo
    ? "m-0 self-stretch bg-black flex flex-col items-center justify-start pt-[70px] pb-0 px-[80px] mq825:px-[50px] box-border gap-[33.5px] max-w-full lg:box-border mq825:gap-[17px] mq825:pt-[45px] mq825:box-border"
            ...
            <div className="self-stretch flex flex-row flex-wrap items-start justify-start gap-[37px] mq825:gap-[18px]">
              <div className="flex-1 flex flex-col items-start justify-start gap-[17px] min-w-[203px]">
                <div className="self-stretch flex flex-col items-start justify-start gap-[1px]">
                  <div className="w-[285px] flex flex-row items-start justify-start py-0 px-[7px] box-border">
                    <div
                      className={classNames(
                        "flex-1 relative text-base leading-[150%] font-small-text text-left z-[1]",
                  ...
                  <input
                    className={classNames(
                      "[outline:none] bg-[transparent] self-stretch h-[45px] relative font-small-text p-3 text-base text-white text-left rounded-lg box-border min-w-[187px] z-[1] border-[2px] border-solid",
            ...
            <div className="flex-1 flex flex-row items-start justify-start max-w-full gap-[20px] mq825:flex-wrap">
              <div className="flex flex-row items-center justify-center gap-[15px]">
                <input
                  ...
                  value="yes"
                  className={classNames(
                    "relative rounded-full box-border z-[1] border-[0px] border-solid h-5 w-5",
                ...
                <label
                  htmlFor={`yes-${id}`}
                  className={classNames(
                    "flex-1 relative text-base leading-[150%] font-small-text  text-left z-[1] pt-1",
