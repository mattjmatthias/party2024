  ...
  return (
    <div className="flex-1 flex flex-col items-start justify-start gap-[10px] mq825:min-w-[145px] mq825:max-w-[145px] min-w-[190px] max-w-[190px]">
            ...
            <div className="flex flex-col items-start justify-start gap-[14px]">
              ...
              <a className="cursor-pointer no-underline [border:none] py-[7px] px-6 bg-black shadow-[0px_1px_2px_rgba(0,_0,_0,_0.05)] rounded-lg flex flex-row items-start justify-start hover:bg-darkslategray-100"
                href={link}
                target="_blank" rel="noopener noreferrer">
